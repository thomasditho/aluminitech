...
function RealCheckoutForm({ amount, currency, currencySymbol, tierName, onSuccess }: CheckoutFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!cardNumberElement || !stripe) {
      setErrorMessage("Problema interno ao carregar o módulo de pagamento seguro.");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      if (!res.ok || data.error) {
        throw new Error(data.error || "Erro ao gerar canal seguro de pagamento.");
      }
      ...
      if (result.paymentIntent?.status === "succeeded") {
        ...
        throw new Error("O pagamento não pôde ser completado.");
      }
    } catch (err: any) {
      console.error("Falha no pagamento:", err);
      setErrorMessage(err.message || "Ocorreu um erro ao processar o seu pagamento.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="pt-4 border-t border-slate-100 flex flex-col items-center gap-2">
        ...
        <p className="text-[9px] text-slate-400 text-center font-sans">
          Criptografia de ponta a ponta processada via Stripe Gateway.
        </p>
      </div>
    </form>
  );
...
function MockCheckoutForm({ amount, currency, currencySymbol, tierName, onSuccess }: CheckoutFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!donorName || !donorEmail || !cardNumber || !cardExpiry || !cardCvc) {
      setErrorMessage("Por favor, preencha todos os dados de cobrança.");
      return;
    }
        ...
        <div className="relative w-full max-w-[280px] aspect-[1.586/1] rounded-xl bg-gradient-to-br from-zinc-900 via-zinc-950 to-neutral-900 border border-zinc-800 text-white p-4 flex flex-col justify-between overflow-shadow select-none shadow-sm">
          <div className="flex justify-between items-start">
            <div className="flex flex-col">
              ...
              <span className="text-[5px] text-zinc-500 uppercase tracking-widest font-semibold font-mono">LABS GLOBAL APORTE</span>
            </div>
            <VisaLogoSvg />
          </div>
          ...
          <div>
            ...
            <div className="flex justify-between items-end mt-2">
              <div className="flex flex-col">
                <span className="text-[5px] uppercase font-bold text-zinc-500 tracking-widest">Titular</span>
                <span className="font-mono text-[8px] text-zinc-300 uppercase truncate max-w-[130px]">
                  {donorName || "NOME DO APOIADOR"}
                </span>
              </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {loading ? (
          ...
          <div className="flex items-center justify-center gap-1.5 py-1 text-slate-400 text-[10px] uppercase font-mono tracking-wider">
            ...
            <span>Processamento Direct VISA/Mastercard Ativo</span>
          </div>
        )}
        ...
        <div className="pt-4 border-t border-slate-100 flex flex-col items-center gap-2">
          ...
          <p className="text-[9px] text-slate-400 text-center font-sans">
            Transações processadas de forma segura e protegidas por conformidades internacionais.
          </p>
        </div>
      </form>
    </div>
      ...
      <div className="min-h-screen bg-[#f8fafc] text-slate-800 selection:bg-[#f97316]/20 selection:text-slate-900 flex flex-col justify-between font-sans">
          ...
          {!isSuccess ? (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
              ...
              <div className="lg:col-span-5 space-y-6 text-left">
                <div className="space-y-1">
                  <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#f97316] font-mono">SELECIONADO</span>
                ...
                <div className="p-5 rounded-2xl bg-slate-100 border border-slate-200 text-slate-800 space-y-4">
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[9px] font-mono uppercase tracking-widest font-bold text-slate-400">PROGRAMA ALOCADO</span>
                  ...
                  <div className="border-t border-slate-200 pt-3">
                    <span className="text-[9px] font-mono uppercase tracking-widest font-bold text-slate-400 block mb-1.5">RECOMPENSAS DO PLANO:</span>
                    <ul className="space-y-1.5">
                      {selectedTier ? selectedTier.benefits.map((b, idx) => (
                        ...
                        <li className="text-xs text-slate-100 flex items-start gap-1.5 leading-relaxed">
                          <span className="text-[#f97316] font-extrabold text-[10px]">✓</span>
                          <span className="text-slate-600">Acesso completo aos boletins de tecnologia mineral da Aluminitech.</span>
                        </li>
                      )}
                    </ul>
                  </div>
                ...
                <p className="text-[11px] text-slate-400 leading-relaxed font-sans">
                  * Este aporte voluntário tem liberação nominal de apoio emitido pela Aluminitech Labs S.A. no Parque Tecnológico BH-TEC em até 24 horas pós-quitação via e-mail corporativo.
                </p>
              </div>
                ...
                <div className="bg-white border border-slate-200 rounded-3xl shadow-sm p-6 md:p-8">
                  <div className="mb-6 space-y-1 text-left">
                    ...
                    <p className="text-xs text-slate-500">
                      Preencha os campos abaixo de maneira simples e conclua com seu cartão de crédito.
                    </p>
                  </div>
            ...
            <div className="max-w-md mx-auto bg-white border border-slate-200 rounded-3xl p-8 text-center space-y-6 shadow-sm">
              ...
              <div className="space-y-1.5">
                <span className="text-[9px] font-mono uppercase tracking-widest font-bold text-emerald-600 block">APORTE CONFIRMADO // STRIPE SECURE</span>
                ...
                <p className="text-xs text-slate-500 max-w-[34ch] mx-auto leading-relaxed">
                  Operação concluída. Seu fomento nominal para o desenvolvimento mineral já foi registrado no portal.
                </p>
              </div>
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-5 text-left space-y-3 font-mono text-[11px] text-slate-600">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between gap-2">
                    <span className="text-slate-400 text-[10px]">DOADOR</span>
                  ...
                  <div className="flex justify-between gap-2">
                    <span className="text-slate-400 text-[10px]">PROGRAMA</span>
                    <span className="text-slate-800 font-semibold">{modalTitle}</span>
                  </div>
                  <div className="flex justify-between gap-2">
        ...
        <footer className="py-6 border-t border-slate-200 bg-white text-center font-mono text-[9px] text-slate-400">
          <div className="max-w-5xl mx-auto px-6 flex flex-wrap gap-4 justify-between items-center">
            <p>© 2026 ALUMINITECH. Termos e outorgas científicas vigentes.</p>
            <div className="flex gap-4 items-center">
              <VisaLogoSvg />
              <span className="font-semibold tracking-wider font-mono text-[8px]">STRIPE CERTIFIED GATEWAY</span>
            </div>
          </div>
        </footer>
      </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col gap-8 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-zinc-900 border border-zinc-800 rounded-full w-fit">
              ...
              <span className="text-xs text-zinc-400 font-medium tracking-wide">Fundo Internacional de Fomento - União Europeia</span>
            </div>
            <h1
              className="text-5xl md:text-7xl font-bold tracking-tight text-white leading-[1.1] text-balance"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Moldando o amanhã com <span className="text-[#f97316]">precisão industrial</span>.
            </h1>
            <p className="text-lg md:text-xl text-zinc-400 text-pretty max-w-[55ch] leading-relaxed">
              Transformamos o potencial da metalurgia do alumínio em inovação aeroespacial, semicondutores e ciclos ecológicos. Apoie a engenharia com fundos seguros em Euros (€).
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col gap-4 mb-16">
            <h2
              ...
              style={{ fontFamily: "var(--font-display)" }}
            >
              Projetos em Captação Ativa
            </h2>
            <p className="text-zinc-500 max-w-[55ch]">
              Todos os recursos arrecadados em euros são convertidos para o pagamento direto de patentes internacionais, insumos críticos e maquinários importados para fomento.
            </p>
          </div>
                ...
                <div className="p-5 flex flex-col gap-5 flex-1">
                  ...
                  <div className="mt-auto space-y-3 py-1">
                    <div className="flex justify-between text-xs font-semibold">
                      ...
                      <span className="text-zinc-300">{p.progress}% de {p.goal}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-xs pt-1">
                      <span className="text-zinc-500">Captado:</span>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-zinc-800/80 pt-4">
                    <div className="text-[10px] uppercase font-bold text-zinc-500 tracking-wider mb-2">Recompensas ativas:</div>
                    <ul className="space-y-1.5">
          ...
          <div className="mt-12 pt-6 border-t border-zinc-900/40 flex flex-wrap gap-6 items-center justify-between text-zinc-500">
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-2 border border-zinc-800/80 bg-zinc-950 px-3 py-1 rounded text-[10px] font-mono tracking-wider font-semibold uppercase text-zinc-400">
                <span>REDE DE PAGAMENTO AUTORIZADA:</span>
                <VisaLogo />
