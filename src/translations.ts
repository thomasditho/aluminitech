...
export const translations: Record<LanguageType, Translations> = {
  PT: {
    ...
    hero: {
      ...
      titleSecondPart: ".",
      description: "Transformamos o potencial da metalurgia do alumínio em inovação aeroespacial, semicondutores e ciclos ecológicos. Apoie a engenharia com fundos seguros.",
  ...
  EN: {
    ...
    hero: {
      ...
      titleSecondPart: ".",
      description: "We transform the potential of aluminum metallurgy into aerospace innovation, semiconductors, and ecological cycles. Support engineering with secure funds.",
  ...
  ES: {
    ...
    hero: {
      ...
      titleSecondPart: ".",
      description: "Transformamos el potencial de la metalurgia del aluminio en innovación aeroespacial, semiconductores y ciclos ecológicos. Apoye la ingeniería con fondos seguros.",
  ...
  FR: {
    ...
    hero: {
      ...
      titleSecondPart: ".",
      description: "Nous transformons le potentiel de la métallurgie de l'aluminium en innovations aérospatiales, semi-conducteurs et cycles écologiques. Soutenez l'ingénierie avec des fonds sécurisés.",
  ...
  DE: {
    ...
    hero: {
      ...
      titleSecondPart: ".",
      description: "Wir verwandeln das Potenzial der Aluminiummetallurgie in Luft- und Raumfahrtinnovationen, Halbleiter und ökologische Kreisläufe. Unterstützen Sie die Wissenschaft mit sicheren Mitteln.",
  ...
  IT: {
    ...
    hero: {
      ...
      titleSecondPart: ".",
      description: "Trasformiamo il potenziale della metallurgia dell'alluminio in innovazioni aerospaziali, semiconduttori e cicli ecologici. Sostieni la ricerca scientifica con fondi sicuri.",
