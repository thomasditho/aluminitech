...
export const translations: Record<LanguageType, Translations> = {
  ...
  ES: {
    ...
    hero: {
      badge: "Fondo Internacional de Fomento - Unión Europea",
    ...
    checkout: {
      ...
      disclaimer: "* Este aporte voluntario incluye una certificación de apoyo nominal emitida por Aluminitech Labs S.A. en el Tech Park BH-TEC dentro de las 24 horas posteriores a la finalización por correo electrónico corporativo.",
  ...
  FR: {
    ...
    hero: {
      badge: "Fonds de Développement International - Union Européenne",
    ...
    checkout: {
      ...
      disclaimer: "* Cette contribution volontaire comprend un certificat de soutien nominal délivré par Aluminitech Labs S.A. au parc technologique BH-TEC sous 24 heures après finalisation par e-mail professionnel.",
  ...
  DE: {
    ...
    hero: {
      badge: "Internationaler Entwicklungsfonds - Europäische Union",
    ...
    checkout: {
      ...
      disclaimer: "* Dieser freiwillige Beitrag beinhaltet ein nominales Unterstützungszertifikat, das von Aluminitech Labs S.A. im Tech-Park BH-TEC innerhalb von 24 Stunden nach Abschluss per Firmen-E-Mail ausgestellt wird.",
  ...
  IT: {
    ...
    hero: {
      badge: "Fondo di Sviluppo Internazionale - Unione Europea",
    ...
    checkout: {
      ...
      disclaimer: "* Questo contributo volontario include una certificazione di supporto nominale emessa da Aluminitech Labs S.A. presso il Tech Park BH-TEC entro 24 ore dal completamento via e-mail aziendale.",
